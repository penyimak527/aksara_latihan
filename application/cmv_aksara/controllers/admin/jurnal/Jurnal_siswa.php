<?php
class Jurnal_siswa extends CI_Controller
{
	function __construct()
	{
		parent::__construct();
		$this->load->model('admin/jurnal/M_jurnal_siswa', 'model');
	}
	...
	public function index()
	{
		...
		$data['title'] = 'Jurnal Siswa';
		$this->load->view('template/header', $data);
		$this->load->view('admin/jurnal/jurnal_siswa', $data);
