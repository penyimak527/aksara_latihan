...
function refreshPernyataan() {
 ...
 const toolbarOptions = [
        ...
        console.log('Quill.version =', Quill && Quill.version);
        console.log('Snow theme =', Quill && Quill.import && Quill.import('themes/snow'));
        console.log('Has ImageResize =', !!window.ImageResize);
