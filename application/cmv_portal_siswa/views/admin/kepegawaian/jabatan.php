	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form-tambah">
					<div class="mb-2">
						<label for="simpleinput" class="form-label">Nama Jabatan</label>
...
<script>
	$(document).ready(function () {
		...
		$('#dt-length-0').on('change', function () {
			...
			paging($('#data_jabatan .card-mapel'), jumlah);
		});
	})
              ...
              status_aktif = 'Aktif'
						...
						table += `<div class="card-mapel">
          						  <p class="keterangan-hari">
          							...
          							<div class="keterangan-mapel">
          								<div class="keterangan-mapel-kiri">
          									<h5 class="judul-mapel" style="margin:0; margin-top: 8px;">${no++}. ${item.nama_jabatan}</h5>
          								</div>
				...
				$('#data_jabatan').html(table);
				let jumlah_awal = parseInt($('#dt-length-0').val());
				paging($('#data_jabatan .card-mapel'), jumlah_awal);
			}
		});
	}
	...
	function edit(detail) {
		...
		$('#nama_jabatan').val(item.nama_jabatan);
	}
