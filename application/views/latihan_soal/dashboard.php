<div class="card mb-3">
	<div class="card-header border-bottom border-dashed">
		...
		<small class="text-muted">Pusat menu admin/tentor untuk master soal, bank soal, sesi soal, hasil pengerjaan,
			analisa kelas, detail siswa, dan izin preview jawaban.</small>
	</div>
	<div class="card-body">
		<div class="row g-3 mb-3">
			<div class="col-md-2 col-6">
				<div class="border rounded p-3 text-center">
					<h4><?= $ringkasan['total_mapel']; ?></h4><small>Mata Pelajaran</small>
				</div>
			</div>
			<div class="col-md-2 col-6">
				<div class="border rounded p-3 text-center">
					<h4><?= $ringkasan['total_materi']; ?></h4><small>Materi</small>
				</div>
			</div>
			<div class="col-md-2 col-6">
				<div class="border rounded p-3 text-center">
					<h4><?= $ringkasan['total_kategori']; ?></h4><small>Kategori Soal</small>
				</div>
			</div>
			<div class="col-md-2 col-6">
				<div class="border rounded p-3 text-center">
					<h4><?= $ringkasan['total_soal']; ?></h4><small>Bank Soal</small>
				</div>
			</div>
			<div class="col-md-2 col-6">
				<div class="border rounded p-3 text-center">
					<h4><?= $ringkasan['total_sesi']; ?></h4><small>Sesi Aktif</small>
				</div>
			</div>
			<div class="col-md-2 col-6">
				<div class="border rounded p-3 text-center">
					<h4><?= $ringkasan['total_hasil']; ?></h4><small>Hasil</small>
				</div>
			</div>
		</div>
		<div class="row g-3">
